...
export function MultiselectFilter({
  ...
  return (
    <div className="flex items-center gap-0 border rounded-lg bg-card shadow-sm overflow-hidden h-10">
      <div className="flex items-center gap-2 px-3 py-2 bg-card border-r">
      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className="h-10 w-40 justify-between border-0 bg-card focus-visible:ring-0 focus-visible:ring-offset-0 text-sm rounded-none hover:bg-muted/50"
          >
            <span
              className={cn(
                "truncate",
